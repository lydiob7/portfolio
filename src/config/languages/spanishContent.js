const spanishContent = {
    ...
    aboutPage: {
        pageTitle: 'Acerca',
        bio: [
            'Soy Desarrollador Full Stack de Argentina (internacional) con un background en Música Popular. Entusiasta de las tecnologías web, aprender nuevas habilidades, y encontrar nuevas maneras creativas de solucionar problemas.',
